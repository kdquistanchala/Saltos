...
@Named
@SessionScoped
public class InformeVueloController implements Serializable {
    ...
    private List<Horario> horariosR;
    ...
    public List<Horario> getHorariosR() {
        return horariosR;
    }

    public void setHorariosR(List<Horario> horariosR) {
        this.horariosR = horariosR;
    }
    ...
    public void recuperarReserva() {
        ...
        System.out.println("CLIENTE RESERVA"+cliente.getCliente_id());
        horariosR = horarioEJB.listarHorarios(cliente.getCliente_id());

    }

    public void leerReservaDetalle(Horario horarioSeleccionar) {
        horario = horarioSeleccionar;
        vuelo = vueloEJB.encontrarVuelo(horario.getHorario_id());
        recuperarVuelo();
        ...
        tarifa=tarifaEJB.recuperarTarifa(vuelo.getVuelo_id(), cliente.getCliente_id());
        adicional = adicionalEJB.recuperarAdicional(tarifa.getTarifa_id());
        
        total=tarifa.getTarifa_costo() +adicional.getCamarografo_id();
        
    }
    
    public void leerInformeVuelo(Horario horarioSeleccionar) {
        horario = horarioSeleccionar;
        vuelo = vueloEJB.encontrarVuelo(horario.getHorario_id());
